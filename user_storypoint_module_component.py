...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 11 13:01:00 2019
...
print(lin.predict([[storypoint,index,module]]))
print("{} can do work in {} hours".format(username,lin.predict([[storypoint,index,module]])[0]))
